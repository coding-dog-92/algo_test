...
public class MyPanel extends JPanel implements KeyListener,ActionListener{
    ...
    protected void paintComponent(Graphics g){//画笔对象
        ...
        //绘制顶部的标题
        new ImageIcon("C:\\Users\\AGO\\Desktop\\img\\title2.png").paintIcon(this,g,25,11);//创建对象
        //绘制游戏区域
        g.fillRect(25, 125, 1450, 700);
        //绘制小蛇
        //蛇头
        new ImageIcon("C:\\Users\\AGO\\Desktop\\img\\head.png").paintIcon(this, g, snakeX[0], snakeY[0]);

        //蛇身
        for(int i=1;i<length;i++){
            new ImageIcon("C:\\Users\\AGO\\Desktop\\img\\body.png").paintIcon(This, g, snakeX[i], snakeY[i]);
        }
        //游戏的提示语
        if(ifStart==false){
        ...
        //画出食物的位置
        new ImageIcon("C:\\Users\\AGO\\Desktop\\img\\body.png").paintIcon(this, g, foodx, foody);
    }
